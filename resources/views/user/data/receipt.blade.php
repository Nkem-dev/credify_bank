            ...
            <div class="p-6 space-y-4">
                <div class="flex items-center justify-between py-3 border-b dark:border-gray-700">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button onclick="copyReference()" class="text-primary hover:text-primary/80 p-1" title="Copy">
                ...
                <div class="flex items-center justify-between py-3 border-b dark:border-gray-700">
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white">
                        {{ explode(' - ', $transfer->description)[0] }}
                    </span>
                </div>
...
function copyReference() {
    ...
    toast.innerHTML = '<i class="ti ti-check mr-2"></i>Copied!';
...
function shareReceipt() {
    if (navigator.share) {
        navigator.share({
            ...
            text: `₦{{ number_format($transfer->amount, 2) }} Data to {{ $transfer->recipient_phone }} - {{ $transfer->reference }}`
        });
    } else {
        copyReference();
    }
